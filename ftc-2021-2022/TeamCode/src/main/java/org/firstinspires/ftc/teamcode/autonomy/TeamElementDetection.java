...
public class TeamElementDetection extends OpenCvPipeline {
    ...
    public TeamElementDetection(Telemetry telemetry) {
    ...
    public Mat processFrame(Mat input)
    {
        ...
        {
            position = FreightFrenzyPosition.LEFT; // Record our analysis
        ...
        {
            position = FreightFrenzyPosition.CENTER; // Record our analysis
        ...
        {
            position = FreightFrenzyPosition.RIGHT; // Record our analysis
